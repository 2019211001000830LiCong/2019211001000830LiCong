			...
			<table class="table table-condensed">
				...
				<c:forEach var="0" items="${orderList}">
					<tr>
						<td>OID:${o.orderId}</td>
						<td>${o.orderDate}</td>
						<%com.LiCong.model.Order o=(com.LiCong.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LiCong.dao.UserDao userDao=new com.LiCong.dao.UserDao();
						...
						<td class="cart_total">${o.paymentId}
							<%	int n=o.getPaymentId();
								String paymentType=com.LiCong.model.Payment.findByPaymentId(con,n);
